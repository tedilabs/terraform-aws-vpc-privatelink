...
| <a name="output_name"></a> [name](#output\_name) | The VPC Resource Endpoint name. |
...
| <a name="output_resource_configuration"></a> [resource\_configuration](#output\_resource\_configuration) | The ARN of the VPC Lattice Resource Configuration which the VPC Resource Endpoint is connected to. |
